...
if name == "":
    ...
    games.pack(pady=20)
    g1 = tk.Button(games, text="Game 1", width=20, height=5, font=("Courier New", 14))
    g2 = tk.Button(games, text="Game 2", width=20, height=5, font=("Courier New", 14))
    g3 = tk.Button(games, text="Game 3", width=20, height=5, font=("Courier New", 14))
    g1.grid(row=0, column=0, padx=20)
    g2.grid(row=0, column=1, padx=20)
    g3.grid(row=0, column=2, padx=20)
    g4 = tk.Button(root, text="Game 4", width=25, height=5, font=("Courier New", 14))
    g4.pack(pady=(30, 50))
